...
export async function generateArticle(input: GenerateArticleInput): Promise<GenerateArticleResult> {
  ...
  const topicInstruction = useFeatureStoryPrompt
    ? [
        ...
        '- "On Tuesday afternoon, Klaus Müller, 47, discovered that his Späti loyalty card had been replaced with a library card..."',
  ...
  const systemPrompt = [
    ...
    '- NEVER use precise clock times like "at 3:47pm" or "at 8:47am" or "at 6:42 a.m." — they sound forced and draw too much attention.',
    '- Instead use ROUGH times: "Tuesday morning", "around noon", "early evening", "sometime after midnight", "last Thursday", "mid-afternoon".',
    '',
  ...
  const topicsSection = useFeatureStoryPrompt
    ? [
        ...
        '- Include concrete details: "On Tuesday morning, residents of Müllerstraße 23 noticed..."',
  ...
  const userPrompt = [
    ...
    useFeatureStoryPrompt
      ? [
          ...
          '  * Rough times and dates ("Tuesday morning", "last Thursday", "around noon", "early evening")',
